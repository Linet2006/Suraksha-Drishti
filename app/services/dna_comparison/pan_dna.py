...
import os
import cv2
from app.services.agents.salary_slip_agent.image_forensics import error_level_analysis
...
def run_pan_verification(pan_card_image_path: str, ocr_extracted: dict, aadhaar_qr_name: str, all_documents: dict) -> dict:
    ...
    # Layer 1
    pan_number = ocr_extracted.get("pan_number", "").strip().upper()
    format_check = validate_pan_format(pan_number)
